...
public class WorkflowTaskPromptSetNodeAdapter extends XmlAdapter<Element, IPrompt<?>> {
	
	private JAXBContext jaxbContext;
	private DocumentBuilder documentBuilder;

	public WorkflowTaskPromptSetNodeAdapter() {}
			
	public WorkflowTaskPromptSetNodeAdapter(JAXBContext jaxbContext) {
        super();
